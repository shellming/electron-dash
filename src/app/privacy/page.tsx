...
export const metadata = {
    title: 'Privacy Policy - Spacebar Clicker',
    description: 'Privacy Policy for Spacebar Clicker',
};
                ...
                <div className="prose prose-invert max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-slate-300">
                            Welcome to Spacebar Clicker. We respect your privacy and are committed to protecting your personal data.
